...
```{r,message=FALSE,warning=FALSE}
WeatherData$date = lubridate::date(WeatherData$Time)
WeatherData$hour = lubridate::hour(WeatherData$Time)
```
...
```{r,message=FALSE,warning=FALSE,echo=FALSE}
write.csv(mergeData,"D:/Fall 16/ADS/Git Repo Assignemnt 2- Team 7/Part1/Output/MergedData.csv")
```

Now we have our cleaned dataset, we will furthe use this to create our forecast model.